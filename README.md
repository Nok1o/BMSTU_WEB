...
Данный проект направлен на реализацию платформы для онлайн-взаимодействия пользователей. Пользователи продукта смогут создавать и редактировать личные профили, добавлять других пользователей в друзья, писать им сообщения, приватно просмотривать их профиль, а также создавать сообщества и посты, писать комментарии. 
