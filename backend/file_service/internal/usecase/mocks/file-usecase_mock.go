...
func (m *MockFileStorage) UploadManyFiles(ctx context.Context, files []*models.File) ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockFileStorageMockRecorder) UploadManyFiles(ctx, files interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UploadManyFiles", reflect.TypeOf((*MockFileStorage)(nil).UploadManyFiles), ctx, files)
}
