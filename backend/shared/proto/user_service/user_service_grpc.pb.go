...
const (
	...
	UserService_GetUserByUsername_FullMethodName = "/user_service.UserService/GetUserByUsername"
	UserService_GetUserById_FullMethodName       = "/user_service.UserService/GetUserById"
	UserService_LookupUserSession_FullMethodName = "/user_service.UserService/LookupUserSession"
	UserService_SearchSimilarUser_FullMethodName = "/user_service.UserService/SearchSimilarUser"
)
...
func (c *userServiceClient) LookupUserSession(ctx context.Context, in *LookupUserSessionRequest, opts ...grpc.CallOption) (*LookupUserSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_LookupUserSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) SearchSimilarUser(ctx context.Context, in *SearchSimilarUserRequest, opts ...grpc.CallOption) (*SearchSimilarUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_SearchSimilarUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_LookupUserSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_LookupUserSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_SearchSimilarUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SearchSimilarUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
