...
func NewChatHandler(chatUseCase interfaces.ChatUseCase, profileUseCase interfaces.ProfileUseCase, messageService interfaces.MessageService, connService interfaces2.IWebSocketConnectionManager) *ChatHandler {
    return &ChatHandler{
