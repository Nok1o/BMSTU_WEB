...
func NewMessageHandler(messageUseCase interfaces.MessageService, authUseCase interfaces.AuthUseCase, profileUseCase interfaces.ProfileUseCase, policy *bluemonday.Policy) *MessageHandler {
